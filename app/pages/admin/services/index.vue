<template>
  <div>
    <div class="flex justify-between items-center mb-6">
      ...
      <NuxtLink to="/admin/services/create" class="bg-primary hover:bg-primary/90 text-white font-medium py-2 px-4 rounded-lg transition-colors">
        + Add Service
      </NuxtLink>
    </div>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr v-for="service in services" :key="service.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <NuxtLink :to="`/admin/services/${service.id}`" class="text-accent hover:text-accent/80 mr-4">Edit</NuxtLink>
